                      ...
                      <Tooltip title={row.pdfName} enterDelay={500}
                          ...
                          >
                              {hoveredRowIndex === index ?
                                  <a href={row.pdfName} style={{ color: '#405479', textDecoration: 'underline' }}>{row.pdfName}</a> : (row.pdfName.length > 150 ?
                                      <a href={row.pdfName} style={{ color: '#405479', textDecoration: 'underline' }}> {row.pdfName.slice(0, 150) + '...'}</a> :
                                      <a href={row.pdfName} style={{ color: '#405479', textDecoration: 'underline' }}>{row.pdfName}</a>)}
                          </div>
                      </Tooltip>
                  </TableCell>
                    <TableCell
